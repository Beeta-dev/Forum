...
$smilies = array(
	...
	':chorar:'=> 'icon_cry.gif',
	':demonio:'=> 'icon_evil.gif',
	':malefico:'=> 'icon_twisted.gif',
	...
	':seta:'=> 'icon_arrow.gif',
	':-|'=> 'icon_neutral.gif',
	':ironico:'=> 'icon_mrgreen.gif',
	':ha:'=> 'icon_ha.gif',
	':love:'=> 'icon_love.gif',
	':incrivel:'=> 'icon_awesome.gif',
	':chorar2:'=> 'icon_coolcry.gif',
	':chorar3:'=> 'icon_cryingalot.gif',
	':chorar4:'=> 'icon_cryingoffelicity.gif',
	':lagrimas:'=> 'icon_crylolim.gif',
	':girl:'=> 'icon_emosit.gif',
	':emocao:'=> 'icon_emotion.gif',
	':cobrindorosto:'=> 'icon_facepalm.gif',
	':fuuu:'=> 'icon_fuuu.gif',
	':piscadela:'=> 'icon_girlblink.gif',
	':gamado:'=> 'icon_ilove.gif',
	':lolsuper:'=> 'icon_lolsuper.gif',
	':amorodio:'=> 'icon_loveangry.gif',
	':bigode:'=> 'icon_mustache.gif',
	':nem:'=> 'icon_not.gif',
	':magoado:'=> 'icon_nvm.gif',
	':omg2:'=> 'icon_omg.gif',
	':omg3:'=> 'icon_omgrollt.gif',
	':oopscool:'=> 'icon_oopscool.gif',
	':setarosa:'=> 'icon_pinkarrow.gif',
	':rimbuk:'=> 'icon_rimbuk.gif',
	':rimbuk2:'=> 'icon_rimkuk2.gif',
	':rock:'=> 'icon_rock.gif',
	':girlshocked:'=> 'icon_shockblond.gif',
	':girlhappy:'=> 'icon_shocknorw.gif',
	':girlsad:'=> 'icon_shockpink.gif',
	':suando:'=> 'icon_sweattz.gif',
	':vamp:'=> 'icon_vamp.gif',
	':feliz2:'=> 'icon_vryhappy.gif',
	':triste2:'=> 'icon_vrysad.gif',
	':queixo:'=> 'icon_wtff.gif',
	':xis:'=> 'icon_xis.gif',
	':et:'=> 'et.gif',
	':ayy:'=> 'et.gif',
	':pingu:'=> 'pingu.gif',
	...
	':n64:'=> 'icon_n64.gif',
	':3do:'=> 'icon_3do.gif',
	':cube2:'=> 'icon_cube2.gif',
	':dc2:'=> 'icon_dc2.gif',
	':duo:'=> 'icon_duo.gif',
	':famicom:'=> 'icon_fc1.gif',
	':famicom2:'=> 'icon_fc2.gif',
	':gameboy:'=> 'icon_gb.gif',
	':gamegear:'=> 'icon_gg.gif',
	':jaguar:'=> 'icon_jg.gif',
	':lynx:'=> 'icon_lyx.gif',
	':megadrive:'=> 'icon_md.gif',
	':neogeocd:'=> 'icon_nc.gif',
	':nes:'=> 'icon_nes.gif',
	':neogeopocket:'=> 'icon_np.gif',
	':pcengine:'=> 'icon_pce.gif',
	':psone:'=> 'icon_ps1.gif',
	':ps22:'=> 'icon_ps22.gif',
	':saturn:'=> 'icon_sat.gif',
	':superfamicom:'=> 'icon_sfc.gif',
	':snes:'=> 'icon_snes.gif',
	':virtualboy:'=> 'icon_vb.gif',
	':wonderswan:'=> 'icon_ws.gif',
	':xb2:'=> 'icon_xbox2.gif',
	':32x:'=> '32x.gif',
	':ngage:'=> 'icon_ngage.gif',
	':ps3:'=> 'icon_ps31.gif',
	':ps3b:'=> 'icon_ps32.gif',
	':rev:'=> 'icon_rev.gif',
	':ds:'=> 'icon_ds.gif',
	':x360:'=> 'icon_x360.gif',
	':x360b:'=> 'icon_x360l.gif',
	':psp:'=> 'icon_psp.gif'
	);

/*
,
	':bocao:'=> 'jose_bocao.png',
	':bus:'=> 'jose_bus.gif',
	':joserimbuk:'=> 'jose_rimbuk.png',
	':joserimbuk2:'=> 'jose_rimbuk2.png',
	':joserock:'=> 'jose_rock.gif'
*/
...
function strip_empty_bbcode($text)
{
	...
	// Remove empty tags
	while (!is_null($new_text = preg_replace('%\[(b|u|s|ins|del|em|i|h|colou?r|quote|img|xavier|youtube|dailymotion|vimeo|uolmais|uolaudio|url|email|list|topic|post|forum|user)(?:\=[^\]]*)?\]\s*\[/\1\]%', '', $text)))
	{
		if ($new_text != $text)
			$text = $new_text;
		else
...
function handle_img_tag($url, $is_signature = false, $alt = null)
{
	...
	{
		$webm = substr($url, 0,strlen($url)-4)."webm";
		$mp4 = substr($url, 0,strlen($url)-4)."mp4";
		$img_tag = '<video autoplay loop poster="placeholder.jpg" id="backgroundgif"> <source src="'.$webm.'" type="video/webm"> <source src="'.$mp4.'"" type="video/mp4"></video>';
	}		
	else
	{
		if (is_null($alt))
...
function do_bbcode($text, $is_signature = false)
{
	...
	$pattern[] = '%\[h\](.*?)\[/h\]%ms';
	$pattern[] = '%\[xavier\](.*?)\[/xavier\]%ms';
	$pattern[] = '%\[youtube\]([-\w]{11}(\?[\w=&]+)?)\[/youtube\]%ms';
	$pattern[] = '%\[dailymotion\](.*?)\[/dailymotion\]%ms';
	$pattern[] = '%\[vimeo\](.*?)\[/vimeo\]%ms';
	$pattern[] = '%\[soundcloud\](.*?)\[/soundcloud\]%ms';
	$pattern[] = '%\[uolmais\](.*?)\[/uolmais\]%ms';
	$pattern[] = '%\[uolaudio\](.*?)\[/uolaudio\]%ms';
	$pattern[] = '%\[gfycat\](.*?)\[/gfycat\]%ms';
	...
	$replace[] = '</p><h5>$1</h5><p>';
	$replace[] = '<div class="videowrapper"><iframe src="http://flashservice.xvideos.com/embedframe/$1" frameborder=0 width=640 height=360 scrolling=no></iframe></div>';
	$replace[] = '<div class="videowrapper"><iframe width="640" height="360" allowfullscreen="1" src="http://www.youtube.com/embed/$1" frameborder="0"></iframe></div>';
	$replace[] = '<div class="videowrapper"><iframe frameborder="0" width="640" height="360" src="//www.dailymotion.com/embed/video/$1" allowfullscreen></iframe></div>';
	$replace[] = '<div class="videowrapper"><iframe src="//player.vimeo.com/video/$1" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>';
	$replace[] = '<iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/$1&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>';
	$replace[] = '<object width="550" height="439" id="player_$1" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param value="true" name="allowfullscreen"/><param value="http://player.mais.uol.com.br/embed_v2.swf?mediaId=$1&tv=0" name="movie"/><param value="always" name="allowscriptaccess"/><param value="window" name="wmode"/><embed id="player_$1" width="550" height="439" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" src="http://player.mais.uol.com.br/embed_v2.swf?mediaId=$1&tv=0" wmode="window" /></embed><noscript><a href="http://mais.uol.com.br/view/$1">Vídeo Mais UOL</a></noscript></object>';
	$replace[] = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="330" height="50" align="middle"><param name="allowScriptAccess" value="sameDomain" /><param value="transparent" name="wmode"/><param name="movie" value="http://storage.mais.uol.com.br/embed_audio2.swf?mediaId=$1" /><param name="quality" value="high" /><embed src="http://storage.mais.uol.com.br/embed_audio2.swf?mediaId=$1" quality="high" width="330" height="50" swLiveConnect=true align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" wmode="transparent" /></embed></object>';
	$replace[] = '<img class="gfyitem" data-title=true data-controls=true data-id="$1" />';
...
function do_smilies($text)
{
	...
	foreach ($smilies as $smiley_text => $smiley_img)
	{
		if (strpos($text, $smiley_text) !== false)
			$text = ucp_preg_replace('%(?<=[>\s])'.preg_quote($smiley_text, '%').'(?=[^\p{L}\p{N}])%um', '<img src="'.pun_htmlspecialchars(get_base_url(true).'/img/emos/'.$smiley_img).'" width="15" height="15" alt="'.substr($smiley_img, 0, strrpos($smiley_img, '.')).'" />', $text);
	}
...
function do_smilies($text)
{
    //global $pun_config, $smilies; // $pun_config? needed? O.o'
    global $smilies;
	...
	foreach($replace as &$smiley_img)
		$smiley_img = '<img src="'.pun_htmlspecialchars(get_base_url(true).'/img/emos/'.$smiley_img).'" alt="'.substr($smiley_img, 0, strrpos($smiley_img, '.')).'" />';
        return implode(" ", str_replace($search, $replace, $text));
}
